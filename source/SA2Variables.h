...
DataPointer(bool, SonicLightShoesGot, 0x1DEB300);
DataPointer(bool, SonicAncientLightGot, 0x1DEB301);
DataPointer(bool, SonicMagicGlovesGot, 0x1DEB302);
DataPointer(bool, SonicFlameRingGot, 0x1DEB303);
DataPointer(bool, SonicBounceBraceletGot, 0x1DEB304);
DataPointer(bool, SonicMysticMelodyGot, 0x1DEB305);
DataPointer(bool, TailsBoosterGot, 0x1DEB306);
DataPointer(bool, TailsBazookaGot, 0x1DEB307);
DataPointer(bool, TailsLaserBlasterGot, 0x1DEB308);
DataPointer(bool, TailsMysticMelodyGot, 0x1DEB309);
DataPointer(bool, KnucklesShovelClawGot, 0x1DEB30A);
DataPointer(bool, KnucklesSunglassesGot, 0x1DEB30B);
DataPointer(bool, KnucklesHammerGlovesGot, 0x1DEB30C);
DataPointer(bool, KnucklesAirNecklaceGot, 0x1DEB30D);
DataPointer(bool, KnucklesMysticMelodyGot, 0x1DEB30E);
DataPointer(bool, ShadowAirShoesGot, 0x1DEB310);
DataPointer(bool, ShadowAncientLightGot, 0x1DEB311);
DataPointer(bool, ShadowFlameRingGot, 0x1DEB312);
DataPointer(bool, ShadowMysticMelodyGot, 0x1DEB313);
DataPointer(bool, EggmanJetEngineGot, 0x1DEB314);
DataPointer(bool, EggmanLargeCannonGot, 0x1DEB315);
DataPointer(bool, EggmanLaserBlasterGot, 0x1DEB316);
DataPointer(bool, EggmanProtectiveArmorGot, 0x1DEB317);
DataPointer(bool, EggmanMysticMelodyGot, 0x1DEB318);
DataPointer(bool, RougePickNailsGot, 0x1DEB319);
DataPointer(bool, RougeTreasureScopeGot, 0x1DEB31A);
DataPointer(bool, RougeIronBootsGot, 0x1DEB31B);
DataPointer(bool, RougeMysticMelodyGot, 0x1DEB31C);
